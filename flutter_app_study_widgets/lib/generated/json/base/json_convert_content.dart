...
class JsonConvert<T> {
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		}	else if(type == (TestModelResult).toString()){
			return TestModelResult().fromJson(json);
		}	else if(type == (TestModelResultData).toString()){
			return TestModelResultData().fromJson(json);
		}	else if(type == (AppDioNetRequestEntity).toString()){
		...
		}	else if(type == (NetCodeEntity).toString()){
